...
VIRTUAL CLWrapper *FullyConnectedLayer::getOutputWrapperTest() {
#if TRANSFERCL_VERBOSE == 1
LOGI( "DeepCL/src/fc/FullyConnectedLayer.cpp: getOutputWrapper");
#endif


    return convolutionalLayer->getOutputWrapperTest();
}
VIRTUAL CLWrapper * FullyConnectedLayer::getOutput8bitInfo(float &_min,float &_mult){
#if TRANSFERCL_VERBOSE == 1
LOGI( "DeepCL/src/conv/ActivationLayer.cpp: getOutputWrapper");
#endif

	return convolutionalLayer->getOutput8bitInfo(_min,_mult);
