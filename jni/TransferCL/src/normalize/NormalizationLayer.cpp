...
VIRTUAL CLWrapper *NormalizationLayer::getOutputWrapperTest() {
#if TRANSFERCL_VERBOSE == 1
LOGI( "DeepCL/src/conv/ConvolutionalLayer.cpp: getOutputWrapper");
#endif
...
VIRTUAL CLWrapper * NormalizationLayer::getOutput8bitInfo(float &minW,float &multW){
#if TRANSFERCL_VERBOSE == 1
LOGI( "DeepCL/src/conv/NormalizationLayer.cpp: getOutput8bitInfo");
#endif
	minW=min;
	multW=mult;
