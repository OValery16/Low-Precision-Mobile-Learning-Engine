...
VIRTUAL void PoolingBackward::backwardHalf(int batchSize, CLWrapper *gradOutputWrapper, CLWrapper *selectorsWrapper, CLWrapper *gradInputWrapper,CLWrapper * inputWrapper) {
#if TRANSFERCL_VERBOSE == 1
LOGI( "DeepCL/src/pooling/PoolingBackward.cpp: backward");
#endif
