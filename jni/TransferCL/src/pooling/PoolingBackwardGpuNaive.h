...
public:
    ...
    VIRTUAL void backwardHalf(int batchSize, CLWrapper *gradOutputWrapper, CLWrapper *selectorsWrapper,CLWrapper *gradInputWrapper,CLWrapper * inputWrapper);
    ...
    void buildKernelBackwardHalf( string kernelSource,int previousLayer_activationLayer);
    void  setActivationFunction(TemplatedKernel *builder,int previousLayer_activationLayer);
    void  setActivationFunctionHalf(TemplatedKernel *builder,int previousLayer_activationLayer);
    void setupBuilderBackwardHalf(TemplatedKernel *builder,int previousLayer_activationLayer);
    // [[[end]]]
};
