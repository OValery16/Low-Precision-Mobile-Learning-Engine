...
VIRTUAL CLWrapper *Layer::getGradInputWrapperTest() {
#if TRANSFERCL_VERBOSE == 1
LOGI( "DeepCL/src/layer/Layer.cpp: getGradInputWrapper");
#endif


    throw std::runtime_error("getGradInputWrapperTest not implemented for " + getClassName());
}
...
PUBLICAPI VIRTUAL CLWrapper * Layer::getOutput8bitInfo(float & min,float &mult) {
#if TRANSFERCL_VERBOSE == 1
LOGI( "DeepCL/src/layer/Layer.cpp: getOutputWrapper");
#endif


    throw std::runtime_error("getOutput8bitInfo not implemetned for " + getClassName());
}

PUBLICAPI VIRTUAL CLWrapper *Layer::getOutputWrapperTest() {
#if TRANSFERCL_VERBOSE == 1
LOGI( "DeepCL/src/layer/Layer.cpp: getOutputWrapper");
#endif
