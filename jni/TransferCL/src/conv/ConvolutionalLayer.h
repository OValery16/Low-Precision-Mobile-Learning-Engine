...
//    ActivationFunction const *const activationFunction;
    ...
    CLWrapper *dataStorageWrapper;

    int iteration;
    int count;

    //////////////
    CLWrapper *inputWrapperTest;
    CLWrapper *outputWrapperTest=0;
    CLWrapper* weightsWrapperHalf;
    CLWrapper* biasWrapperHalf;
    CLWrapper *gradInputWrapperHalf;
    //////////////////
    CLWrapper *gradInput_poolingLayer_Wrapper;
    CLWrapper *gradInput_poolingLayer_WrapperHalf;
    /////////////////////////
    //8bits Wrapper
    CLWrapper *dataStorageWrapper8Bit;
    CLWrapper *inputWrapper8Bit;
    CLWrapper *outputWrapper8Bit;
    CLWrapper* weightsWrapper8Bit;
    CLWrapper* biasWrapper8Bit;

    //quatification parameters
	float minI;
	float multI;
	float minO;
	float multO;
	...
	float multW;
///////////////////
    std::vector<CLWrapper *>dataStorageWrapper8BitTEST;
    CLWrapper *bigDataStorageWrapper8Bit;
    //////////////////
...
//    }
    ...
    VIRTUAL CLWrapper *getGradInputWrapperTest();
    ...
    VIRTUAL CLWrapper *getOutputWrapperTest();
    ...
    void randomizeWeightsHalf(WeightsInitializer *weightsInitializer);
    void randomizeFCWeightsHalf(WeightsInitializer *weightsInitializer);
    ...
    VIRTUAL CLWrapper * getOutput8bitInfo(float &_min,float &_mult);
    void encode8BitWeight(const float * array,int len, unsigned char *dst,float &minW,float &multW);
    // [[[end]]]
};
