...
///////////////////
    ...
    VIRTUAL void encode8BitWeight(const float * array,int len, unsigned char *dst,float &minW,float &multW);
    VIRTUAL CLWrapper * getOutput8bitInfo(float &min,float &mult);
    // [[[end]]]
};
