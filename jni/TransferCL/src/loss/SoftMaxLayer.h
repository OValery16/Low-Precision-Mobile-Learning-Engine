...
public:
    ...
    ////////////////
    CLKernel *kernelHalf;
    CLWrapper *labelWrapperHalf;
    CLWrapper * nbRightWrapperHalf;
    CLWrapper *lossWrapperHalf;
    CLWrapper * inputWrapperHalf;
	...
	void buildKernelSoftmax_forwardHalf();
	void setupBuilderSoftmax_forwardHalf(TemplatedKernel *builder);
	STATIC std::string getKernelTemplateSoftmax_forwardHalf();
	void runSoftmax_forwardHalf(CLWrapper *inputWrapper/*,CLWrapper *outputWrapper*/,int const *labels) ;
