...
//(olivier) add half floating poin support
...
public:
    ...
    CLCharWrapper *wrap8Bit(int N, unsigned char *source);
    ...
    CLKernel *buildKernelFromStringOnlineBuilding(string operation,string source, string kernelname, string options, string sourcefilename);
