...
#include "clblast_half.h"//(olivier) add half floating poin support
...
public:
    ...
    virtual half* map_ZeroCopyObject_WriteFlagHalf();
    virtual void unMap_ZeroCopyObject_WriteFlagHalf(float *ptr);
    virtual float* map_ZeroCopyObject_ReadFlag();
    virtual void unMap_ZeroCopyObject_ReadFlag(float *ptr);
    virtual int* map_ZeroCopyObject_ReadFlagInt();
    virtual void unMap_ZeroCopyObject_ReadFlagInt(int *ptr);
    virtual half* map_ZeroCopyObject_ReadFlagHalf();
    virtual void unMap_ZeroCopyObject_ReadFlagHalf(half *ptr);
    virtual void unMap_ZeroCopyObject_WriteFlagHalf(half *ptr);
    virtual unsigned char * map_ZeroCopyObject_WriteFlag8Bit();
    virtual void unMap_ZeroCopyObject_WriteFlag8Bit(unsigned char *ptr);
    virtual unsigned char * map_ZeroCopyObject_ReadFlag8Bit();
    virtual void unMap_ZeroCopyObject_ReadFlag8Bit(unsigned char *ptr);
    virtual void copyToHost();
    virtual cl_mem getBuffer();
    virtual void copyToDevice();
    virtual void copyToDevice_ZeroCopyObject_ReadWriteFlag(const void * buffer);
    virtual void copyToDevice_ZeroCopyObject_ReadWriteFlagHalf(const void * buffer);
    virtual void copyToDevice_ZeroCopyObject_WriteFlag(const void * buffer);
    virtual void copyToDevice_ZeroCopyObject_WriteFlagHalf(const void * buffer);
    virtual void copyToDevice_ZeroCopyObject_WriteFlagFloat(const void * buffer);
