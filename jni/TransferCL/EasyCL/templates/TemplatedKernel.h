...
public:
    ...
    CLKernel *buildKernelTest(std::string uniqueName, std::string filename, std::string templateSource, std::string kernelName, bool useKernelStore,std::string t);
    std::string getRenderedKernel(std::string templateSource);
    CLKernel *buildKernelOnline(std::string uniqueName, std::string filename, std::string templateSource, std::string kernelName, bool useKernelStore, std::string t);
    private:
