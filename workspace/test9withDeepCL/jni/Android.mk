...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/Eigen $(LOCAL_PATH)/unsupported
...
LOCAL_SRC_FILES :=trainEngine/train.cpp predictEngine/predict.cpp $(notdir $(LOCAL_PATH)/TransferCL)/src/conv/table_str.cpp
...
LOCAL_SRC_FILES += $(notdir $(LOCAL_PATH)/)kernelManager/ConfigManager.cpp $(notdir $(LOCAL_PATH)/TransferCL)/src/loaders/MnistLoader.cpp
LOCAL_LDLIBS 	:= -llog -ljnigraphics 
#LOCAL_SHARED_LIBRARIES := libjpegturboSIMD 
LOCAL_SHARED_LIBRARIES += libeigen 
